...
#include "include/fenglingDict.h"
...
static int global_conf_init(void) {
    g_global_conf.S0port = get_var_str("global.S0port", "8080");
    g_global_conf.S1port = get_var_int("global.S1port", 4433);
    g_global_conf.C0port = get_var_int("global.C0port", 80);
    g_global_conf.S1MaxListen = get_var_int("global.S1MaxListen", 1);
    g_global_conf.Spem = get_var_str("global.Spem", "/server.pem");
    g_global_conf.Skey = get_var_str("global.Skey", "/server.key");
    g_global_conf.Ccrt = get_var_str("global.Ccrt", "/ca.crt");
    g_global_conf.CServerAddr = get_var_str("global.CServerAddr", "fengiling.com.cn:4433");
    g_global_conf.Domain = get_var_str("global.Domain", "fengiling.com.cn");
    g_global_conf.SubDomain = get_var_str("global.SubDomain", "www");
    g_global_conf.SMaxPoll = get_var_int("global.SMaxPoll", 20);
    g_global_conf.CMaxPoll = get_var_int("global.CMaxPoll", 2);
    ...
    g_global_conf.upstream = get_var_str("global.upstream", "./conf/upstream");
    g_global_conf.upstream_reload_time = get_var_int("global.upstream_reload_time", 3600);
    
    g_global_conf.WorkPath = get_var_str("global.WorkPath", getcwd(NULL, 0));
